...
public class Adamon {
    ...
    public void atacar (Adamon adamonAtacado){
        if(adamonAtacado.getVida() > 0){
            adamonAtacado.setVida(adamonAtacado.getVida() - Math.abs(adamonAtacado.getDefesa() - this.ataque));
        }
    }
